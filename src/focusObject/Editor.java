...
public class Editor{
	...
	public Editor(TreeUIManager tuim) throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException{
		...
		*/
		...
		tuim.addObject(ecp);
		tuim.addItemtoInv((SmallGameObject) tuim.createLooseGameObject(Wirecutters.class, 300, 300));
		tuim.addItemtoInv((SmallGameObject) tuim.createLooseGameObject(Multitool.class, 300, 300));
