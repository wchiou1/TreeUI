...
public class Editor{
	...
	public Editor(TreeUIManager tuim) throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException{
		...
		*/
		...
		tuim.addObject(ecp);
		tuim.addItemtoInv((SmallGameObject) tuim.createGameObject(Wirecutters.class, 300, 300));
		tuim.addItemtoInv((SmallGameObject) tuim.createGameObject(Multitool.class, 300, 300));
